from global_macro_variables.config import FRED_API_KEY, FRED_INTEREST_RATE_SERIES, BLD, OECD_QUARTERLY_GDP_USD_XML_QUERY_LINK , OECD_QUARTERLY_CURRENT_ACCOUNT_QUERY_LINK, OECD_REAL_QUARTERLY_GDP_QUERY_LINK
from global_macro_variables.import_data import import_10y_yields_data_series_from_fred, import_quarterly_gdp_data_in_USD_from_oecd, import_quarterly_current_account_from_OECD, import_real_quarterly_gdp_data_from_oecd
...
def task_import_fred_series(series_id = FRED_INTEREST_RATE_SERIES, 
                            ...
                            produces= BLD / 'data' / 'fred_data' / 'fred_test_data.csv'):
